...
![11](D:\GitLoadWareHouse\pictures\11.png)

 使用右上角的**Sign in**或者点击开始你的项目，弹出登录界面。这里以**Github**账号登录。

![12](D:\GitLoadWareHouse\pictures\12.png)
...
![13](D:\GitLoadWareHouse\pictures\13.png)

当然， 如果，你不小心关闭了**Supabase的网页**，找不到API、URL，点击你创建的项目（我这里是Quivr），**进入**。

![14](D:\GitLoadWareHouse\pictures\14.png)

 点击**【设置】**中的**API**，你看，现在就又可以瞧见了。

![15](D:\GitLoadWareHouse\pictures\15.png)
...
![16](D:\GitLoadWareHouse\pictures\16.png)
...
![17](D:\GitLoadWareHouse\pictures\17.png)
...
![18](D:\GitLoadWareHouse\pictures\18.png)

打开**Github**中**Quivr**的开源地址，对**Code**（编码）中的地址进行复制。

![19](D:\GitLoadWareHouse\pictures\19.png)

输入**git clone +URL**粘贴到**Git界面**，这里**粘贴**的时候需要用**鼠标右键复制**，快捷键并不是默认的ctrl+C,然后点击回车键。

![20](D:\GitLoadWareHouse\pictures\20.png)

等一会儿就基本下载完了，应该是需要一会儿。

![21](D:\GitLoadWareHouse\pictures\21.png)
...
![24](D:\GitLoadWareHouse\pictures\24.png)
...
![25](D:\GitLoadWareHouse\pictures\25.png)
...
![26](D:\GitLoadWareHouse\pictures\26.png)
...
![27](D:\GitLoadWareHouse\pictures\27.png)
...
![28](D:\GitLoadWareHouse\pictures\28.png)
...
![29](D:\GitLoadWareHouse\pictures\29.png)

这里选择**API**，点击进入。

![30](D:\GitLoadWareHouse\pictures\30.png)

打开**API keys**，选择【**创建新的密钥**】，输入一个名称，点击创建就可以。

![31](D:\GitLoadWareHouse\pictures\31.png)

 复制**API密钥**就好。

![32](D:\GitLoadWareHouse\pictures\32.png)
...
![33](D:\GitLoadWareHouse\pictures\33.png)

#####     2、更改变量frontend/ .env

找到**frontend**文件夹下的**.env**，打开。

![34](D:\GitLoadWareHouse\pictures\34.png)
...
![35](D:\GitLoadWareHouse\pictures\35.png)
...
![36](D:\GitLoadWareHouse\pictures\36.png)

 打开**Table**，选择右上角的**Coep raw file**，进行复制。

![37](D:\GitLoadWareHouse\pictures\37.png)
...
![38](D:\GitLoadWareHouse\pictures\38.png)

找到右下角**Run**，运行table.Sql（表）。

![39](D:\GitLoadWareHouse\pictures\39.png)

 运行完毕，你就可以看到数据库已经弄好了。

![40](D:\GitLoadWareHouse\pictures\40.png)
...
![41](D:\GitLoadWareHouse\pictures\41.png)
...
![42](D:\GitLoadWareHouse\pictures\42.png)
...
![43](D:\GitLoadWareHouse\pictures\43.png)

 往下划，找到谷歌，这里需要设置谷歌的**客户端ID**与**客户端密钥**。

![44](D:\GitLoadWareHouse\pictures\44.png)
...
![45](D:\GitLoadWareHouse\pictures\45.png)

 应用程序选择**网页应用程序**。

![46](D:\GitLoadWareHouse\pictures\46.png)

-  **URI1*：已授权的JavaScript**

 **URI1*：**输入你的本地地址：http://localhost:3000

![47](D:\GitLoadWareHouse\pictures\47.png)

-  **URI1：已授权的重新导向*：**

 这里输入在**Supabase授权中谷歌**哪里会提供一个**重向导向URI**

![48](D:\GitLoadWareHouse\pictures\48.png)

 然后点击建立就可。

![49](D:\GitLoadWareHouse\pictures\49.png)

 此时，你会发现多了一个客户端，打击打开，就会出现你需要的谷歌**客户端ID**与**客户端密钥**。

![50](D:\GitLoadWareHouse\pictures\50.png)

 再次返回**Supabase**谷歌**授权中**填入相关信息，保存，等大概三四分钟。

![51](D:\GitLoadWareHouse\pictures\51.png)

 再次在浏览器打开**本地地址**：http://localhost:3000。

![52](D:\GitLoadWareHouse\pictures\52.png)

发现出现账号登录界面，选择自己账号，如果没有在浏览器登录，可以输入邮箱和密码。

![53](D:\GitLoadWareHouse\pictures\53.png)

  如此，就**登陆成功**。

![图片1](C:\Users\Welcome Majun\Desktop\图片1.png)
