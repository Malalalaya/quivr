...
![](E:\quivr\pictures\29.png)

这里选择**API**，点击进入。

![](E:\quivr\pictures\30.png)

打开**API keys**，选择【**创建新的密钥**】，输入一个名称，点击创建就可以。

![](E:\quivr\pictures\31.png)

 复制**API密钥**就好。

![](E:\quivr\pictures\32.png)
...
![](E:\quivr\pictures\33.png)

#####     2、更改变量frontend/ .env

找到**frontend**文件夹下的**.env**，打开。

![](E:\quivr\pictures\34.png)
...
![](E:\quivr\pictures\36.png)

 打开**Table**，选择右上角的**Coep raw file**，进行复制。

![](E:\quivr\pictures\37.png)
...
![](E:\quivr\pictures\38.png)

找到右下角**Run**，运行table.Sql（表）。

![](E:\quivr\pictures\39.png)

 运行完毕，你就可以看到数据库已经弄好了。

![](E:\quivr\pictures\40.png)
...
![](E:\quivr\pictures\43.png)

 往下划，找到谷歌，这里需要设置谷歌的**客户端ID**与**客户端密钥**。

![](E:\quivr\pictures\44.png)
...
![](E:\quivr\pictures\45.png)

 应用程序选择**网页应用程序**。

![](E:\quivr\pictures\46.png)

-  **URI1*：已授权的JavaScript**

 **URI1*：**输入你的本地地址：http://localhost:3000

![](E:\quivr\pictures\47.png)

-  **URI1：已授权的重新导向*：**

 这里输入在**Supabase授权中谷歌**哪里会提供一个**重向导向URI**

![](E:\quivr\pictures\48.png)

 然后点击建立就可。

![](E:\quivr\pictures\49.png)

 此时，你会发现多了一个客户端，打击打开，就会出现你需要的谷歌**客户端ID**与**客户端密钥**。

![](E:\quivr\pictures\50.png)

 再次返回**Supabase**谷歌**授权中**填入相关信息，保存，等大概三四分钟。

![](E:\quivr\pictures\51.png)

 再次在浏览器打开**本地地址**：http://localhost:3000。

![](E:\quivr\pictures\52.png)

发现出现账号登录界面，选择自己账号，如果没有在浏览器登录，可以输入邮箱和密码。

![](E:\quivr\pictures\53.png)

  如此，就**登陆成功**。

![](E:\quivr\pictures\54.png)
